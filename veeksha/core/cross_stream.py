...
other half of the abstraction (``analysis/10_timing_native_and_generality.md``
§2-3) is *cross-stream*: metrics that align an INPUT timeline against an OUTPUT
...
def events_of_kind(stream: TimedEventStream, kind: str) -> List[StreamEvent]:
    """Events on a (possibly mixed) stream that were produced/sent as ``kind``."""
    return [e for e in stream.events if e.kind == kind]
