...
`analysis/bench/RESULTS.md` (Experiment C) showed the evaluator's single global
...
class ShardedCDFSketch:
    ...
    def to_csv_row(self) -> str:
        return self.to_cdf_sketch().to_csv_row()

    def get_csv_header(self) -> str:
        return self.to_cdf_sketch().get_csv_header()
    ...
    def print_distribution_stats(self, plot_name: str) -> None:
        self.to_cdf_sketch().print_distribution_stats(plot_name)
